...
// Sun Mar 19 18:37:54 2023 by ROOT version 6.24/08
...
#ifdef BARAC_cxx
BARAC::BARAC(TTree *tree) : fChain(0) 
{
...
Int_t BARAC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BARAC::LoadTree(Long64_t entry)
{
...
void BARAC::Show(Long64_t entry)
{
...
Int_t BARAC::Cut(Long64_t entry)
{
